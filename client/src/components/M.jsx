  ...
  <div className="map-cities">
    <div style={{'--x': 5, '--y': 67}} className="map-city">
      <div className="map-city__label">
              <span data-icon="🏖️" className="map-city__sign">{props.b}</span>
      </div>
    </div>
    <div style={{'--x': 32, '--y': 32}} className="map-city">
      <div className="map-city__label">
        <span data-icon="🌷" className="map-city__sign anim anim-grow">{props.b}</span>
      </div>
    </div>
    <div style={{'--x': 58, '--y': 83}} className="map-city">
      <div className="map-city__label">
        <span data-icon="🏄" className="map-city__sign anim anim-slidein">{props.b}</span>
      </div>
    </div>
    ...
    <div style={{'--x': 87, '--y': 58}} className="map-city">
      <div className="map-city__label">
        <span data-icon="🎢" className="map-city__sign">{props.b}</span>
      </div>
    </div>
