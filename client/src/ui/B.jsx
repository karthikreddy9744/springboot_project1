...
<button className="btn-small">
  <div className="btn-small-content">
    <div className="btn-small-icon">
      <svg xmlSpace="preserve" style={{enableBackground: 'new 0 0 80 80'}} viewBox="0 0 80 80" height="40px" width="40px" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg" version="1.1">
        <g>
